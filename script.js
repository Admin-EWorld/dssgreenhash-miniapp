document.addEventListener("DOMContentLoaded", () => {
    setTimeout(() => {
        ...
        let miningInterval, progressInterval, coinPrices = { TON: 4.12, BTC: 60000, USDT: 1 };
        ...
        if (buySharesBtn) {
            buySharesBtn.addEventListener("click", () => {
                ...
                const cost = numShares * 60; // 1 share = $60
                shares += numShares;
                hashPower = shares * 0.1;
                totalDeposited += cost;
                updateUI();
        ...
        const generateReferralLink = () => {
            if (referralLinkDisplay) {
                const userId = window.Telegram.WebApp.initDataUnsafe.user ? window.Telegram.WebApp.initDataUnsafe.user.id : "test_user";
                referralLinkDisplay.textContent = `https://t.me/DSSGreenHashBot?start=${userId}`;
            }
        };
        ...
        // Simulate a referral (for testing)
        ...
        // For testing: Add a button or trigger to simulate a referral
